...
export default function Hero(){
  return (
    <section className="-mt-2 md:mt-10 grid gap-8 md:grid-cols-2 items-center">
      ...
      <motion.div initial={{ scale:0.95, opacity:0 }} animate={{ scale:1, opacity:1 }} transition={{duration:0.6}} className="order-1 md:order-2 flex justify-center md:justify-end -mx-6 sm:mx-0 -mt-4 sm:mt-0">
